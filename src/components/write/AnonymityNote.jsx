    ...
    <div className="mt-6 flex items-start gap-3 p-4 rounded-[20px] bg-[#E9E5DC] text-right">
      ...
      <div>
        ...
        <p className="mt-1 text-[13.5px] text-[#55544E] leading-relaxed">
          לא צריך להירשם ולא נאסף שום פרט מזהה. מה שנכתב נשמר רק במכשיר הזה, לא נשלח לשום מקום, ואף אחד
          אחר לא יכול לקרוא אותו. בסוף הכתיבה אפשר למצוא אותה ב״רגעים ששמרתי״, ואפשר גם לשמור טיוטה באמצע.
        </p>
      </div>
    </div>
  );
