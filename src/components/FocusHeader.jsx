...
export default function FocusHeader({ kicker, title, to }) {
  ...
  return (
    <div className="flex items-start justify-between gap-4 px-6 pt-14">
      ...
      <button
        ...
        aria-label="סגור"
        className="press grid place-items-center w-10 h-10 shrink-0 mt-1 rounded-full bg-secondary text-foreground"
      >
